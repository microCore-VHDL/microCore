...
add wave -noupdate /bench/myFPGA/internal_data_mem/make_sim_mem/internal_data_mem/ram(8)
add wave -noupdate /bench/myFPGA/internal_data_mem/make_sim_mem/internal_data_mem/ram(9)
...
WaveRestoreCursors {{Cursor 1} {48385 ns} 0} {{Cursor 2} {67703 ns} 0}
